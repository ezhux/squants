...
class EnergyIntensitySpec extends FlatSpec with Matchers {
  ...
  it should "create values using UOM factories" in {
    ...
    BtusPerSquareFeet(1).toBtusPerSquareFoot should be (1)
    KilobtusPerSquareFeet(1).toKilobtusPerSquareFoot should be (1)
    MegabtusPerSquareFeet(1).toMegabtusPerSquareFoot should be (1)
  ...
  it should "property convert to all supported Units of Measure" in {
    ...
    x.toBtusPerSquareFoot should be(36.72798930)
    x.toKilobtusPerSquareFoot should be (36.72798930 / MetricSystem.Kilo +- 0.0000001)
    x.toMegabtusPerSquareFoot should be (36.72798930 / MetricSystem.Mega +- 0.0000001)
  }
}
